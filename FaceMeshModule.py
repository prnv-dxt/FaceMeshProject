...
class FaceMeshDetector():
    def __init__(self, staticMode=False, maxFace=2, minDetectionCon=0.5, minTrackCon=0.5):
        ...
        self.faceMesh = self.mpFaceMesh.FaceMesh(self.staticMode, self.maxFace, self.minDetectionCon, self.minTrackingCon)
...
def main():
    ...
    while True:
        ...
        cv2.putText(img, f'FPS {int(fps)}', (20, 40), cv2.FONT_HERSHEY_DUPLEX, 1, (0, 255, 0), 1)
